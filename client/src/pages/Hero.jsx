    ...
    return (
        <div className="relative flex items-center justify-center h-[45em] bg-cover bg-center bg-main-background">
            ...
            <div className="relative text-center z-10">
                <h1 className="mb-8 text-5xl font-bold leading-tight tracking-tight text-white animate-fadeInSlideUp">
                    Индивидуални решения за индустриално и офис обзавеждане
                </h1>
                <p className="mb-6 text-[1.1rem] leading-relaxed px-20 text-white animate-fadeInSlideUp delay-[0.3s]">
